...
def seed_database():
    with app.app_context():
        ...
        reviews = [
            Review(rating=5, title='Amazing chicken!', content='Best fried chicken I have ever had. The garlic sauce is incredible and the prices are very reasonable. Highly recommend!', user_id=1, restaurant_id=1),
            Review(rating=4, title='Great value', content='Tasty food at affordable prices. Sometimes crowded but worth the wait.', user_id=2, restaurant_id=1),
            Review(rating=5, title='Authentic Saudi cuisine', content='The kabsa here is outstanding. Generous portions and authentic flavors. Perfect for family gatherings.', user_id=1, restaurant_id=2),
            Review(rating=4, title='Traditional and delicious', content='Great mandi and excellent service. The atmosphere is very family-friendly.', user_id=3, restaurant_id=2),
            Review(rating=5, title='Best pizza in Jeddah', content='Authentic Italian pizza with fresh ingredients. The margherita is perfection!', user_id=2, restaurant_id=3),
            Review(rating=5, title='Hidden gem', content='Small place but amazing quality. The owner is very friendly and the pizza is delicious.', user_id=4, restaurant_id=3),
            Review(rating=4, title='Great tacos', content='Authentic Mexican flavors. The fish tacos are my favorite!', user_id=1, restaurant_id=4),
            Review(rating=5, title='Love it!', content='Best Mexican food in Jeddah. The atmosphere is fun and the food is amazing.', user_id=3, restaurant_id=4),
            Review(rating=5, title='Fresh and delicious', content='High-quality sushi with excellent presentation. A bit pricey but worth it for special occasions.', user_id=2, restaurant_id=5),
            Review(rating=4, title='Premium experience', content='Great sushi selection and professional staff. The omakase is highly recommended.', user_id=4, restaurant_id=5),
            Review(rating=5, title='Amazing burgers', content='Creative burger combinations and great quality beef. The truffle fries are a must-try!', user_id=1, restaurant_id=6),
            Review(rating=4, title='Good spot', content='Tasty burgers in a casual setting. Good value for money.', user_id=2, restaurant_id=6),
            Review(rating=5, title='Fresh seafood', content='Beautiful location on the corniche with delicious Mediterranean food. The grilled fish is excellent.', user_id=3, restaurant_id=7),
            Review(rating=5, title='Best biryani ever', content='The chicken biryani here is unmatched. Rich flavors and perfect spice level.', user_id=1, restaurant_id=8),
            Review(rating=4, title='Great Lebanese food', content='Authentic mezze and excellent grilled meats. Very friendly staff.', user_id=4, restaurant_id=9),
            Review(rating=5, title='Love the kebabs', content='Authentic Turkish kebabs and wonderful baklava for dessert. Highly recommend!', user_id=2, restaurant_id=10)
        ]
